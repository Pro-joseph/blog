...
@section('title', 'Register | The Technical Editor')
...
<p class="font-body italic text-base md:text-lg text-secondary">Create your account</p>
</div>
...
@csrf
<div>
<label class="block font-sans-tight text-sm font-bold text-on-surface-variant mb-2" for="name">Full Name</label>
<div class="relative">
<div class="absolute inset-y-0 left-0 pl-3 md:pl-4 flex items-center pointer-events-none">
<span class="material-symbols-outlined text-outline text-lg md:text-xl" data-icon="person">person</span>
</div>
<input class="block w-full pl-10 md:pl-11 pr-4 py-3 md:py-3.5 bg-surface-container-low border-none rounded-lg text-on-surface font-sans-tight focus:ring-2 focus:ring-primary/20 focus:bg-surface-container-lowest transition-all duration-200 placeholder:text-outline/50 text-base md:text-base" id="name" name="name" placeholder="John Architect" required="" type="text" value="{{ old('name') }}"/>
</div>
@error('name')
...
<span class="material-symbols-outlined text-xl" data-icon="how_to_reg" style="font-variation-settings: 'FILL' 1;">how_to_reg</span>
Create Account
</button>
</form>
