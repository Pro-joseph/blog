...
@section('body-class', 'bg-surface text-on-surface font-body selection:bg-secondary-container selection:text-on-secondary-container')
...
<a class="text-slate-500 font-medium hover:text-indigo-700 transition-colors duration-200 text-sm" href="{{ route('dashboard') }}">Dashboard</a>
<a class="text-indigo-900 font-bold border-b-2 border-indigo-600 transition-colors duration-200 text-sm" href="{{ route('home') }}">Articles</a>
...
<a class="inline-flex items-center gap-2 group text-primary font-label font-semibold text-sm tracking-wide" href="{{ route('home') }}">
...
<img alt="Author" class="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuB1dwTIQB0N-H1b7HTIRYlxrBr-ev_2apEEsVVpK76VFMZU1g-Pt9fm1kYgDu0V8DSdi_QfL4KKHDe3IxmZ_ckFvWXrGeOhMGKBDCfihEn3gT362LAWnF4jBFPOAZ0qpsqxiPsiI4jWTSW2urFX8cod-DYr8m8cwqAYy1DnOIzoIyK7lq6184EQaPkUR94FRavS3P-6pPMbnzcUVOXJ8-rGrlil65Cao9wa7uDewovxzJl550YLOf_QSFbHoaOCTfy7ra5BrvkMoag"/>
</div>
<div class="flex-1">
